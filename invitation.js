...
const i18n = {
    en: {
        ...
        'church-location': 'Trondheim Baptistmenighet · Prinsens gt. 2D · 7012 Trondheim',
        ...
        'ceremony': '⛪ Wedding Ceremony', 'church-desc': 'Trondheim Baptistmenighet, Prinsens gt. 2D, 7012 Trondheim', 'reception': '🏛️ Reception',
        'venue-map': 'Location',
    ...
    am: {
        ...
        'save-the-date': 'Save the date',
        'church-location': 'ትሮንድሃይም ባፕቲስት ቤተ ክርስቲያን · Prinsens gt. 2D · 7012 Trondheim',
        'countdown-title': 'ለሰርጉ ቀን የቀረው ጊዜ:',
        'timer-days': 'ቀናት', 'timer-hours': 'ሰዓታት', 'timer-mins': 'ደቂቃዎች', 'timer-secs': 'ሴኮንዶች',
        'day-program': 'የቀኑ መርሃ ግብር',
        'ceremony': '⛪ የቃልኪዳን ሥነ ሥርዓት', 'church-desc': 'ትሮንድሃይም ባፕቲስት ቤተ ክርስቲያን፣ Prinsens gt. 2D, 7012 Trondheim', 'reception': '🏛️ ራት',
